...
public class DatumSpeechRecognitionHypothesesFragment extends DatumProductionExperimentFragment {
  ...
  protected static final String[] TAGS = new String[] { "WebSearch", "SMS", "EMail" };
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    View rootView = inflater.inflate(R.layout.fragment_datum_speech_recognition_hypotheses, container, false);
    ...
    if (mItem != null) {
      ...
      IntentFilter intentPartialRecognitionResult = new IntentFilter(Config.INTENT_PARTIAL_SPEECH_RECOGNITION_RESULT);
      getActivity().registerReceiver(this.mRecognitionReceiver, intentPartialRecognitionResult);
  ...
  protected void showOrthographyOnly(View rootView) {
    ...
    TableLayout datumArea = (TableLayout) rootView.findViewById(R.id.datumArea);
    if (datumArea != null) {
    ...
    final AutoCompleteTextView tagsEditText = ((AutoCompleteTextView) rootView.findViewById(R.id.tags));
  ...
  protected void prepareEditTextListeners(final View rootView) {
    hypothesesArea = (TableLayout) rootView.findViewById(R.id.hypothesesArea);

    orthographyEditText = ((EditText) rootView.findViewById(R.id.orthography));

    hypothesis1EditText = ((EditText) rootView.findViewById(R.id.hypothesis1));
    ...
    final ImageButton removeHypothesis1Button = (ImageButton) rootView.findViewById(R.id.removeHypothesis1);
    if (removeHypothesis1Button != null) {
      removeHypothesis1Button.setOnClickListener(new View.OnClickListener() {
        @Override
        public void onClick(View v) {
          removeHypothesis1Button.setVisibility(View.GONE);
          hypothesis1EditText.setVisibility(View.GONE);
          recordUserEvent("removeHypothesis", "hypothesis1:::" + hypothesis1EditText.getText().toString());

        }
      });
    }

    hypothesis2EditText = ((EditText) rootView.findViewById(R.id.hypothesis2));
    if (hypothesis2EditText != null) {
      ...
      hypothesis2EditText.addTextChangedListener(new TextWatcher() {
        ...
        public void onTextChanged(CharSequence arg0, int arg1, int arg2, int arg3) {
          ...
          String currentText = hypothesis2EditText.getText().toString();
          mItem.setOrthography(currentText);
          showOrthographyOnly(rootView);
          ContentValues values = new ContentValues();
          values.put(DatumTable.COLUMN_ORTHOGRAPHY, currentText);
    ...
    final ImageButton removeHypothesis2Button = (ImageButton) rootView.findViewById(R.id.removeHypothesis2);
    if (removeHypothesis2Button != null) {
      removeHypothesis2Button.setOnClickListener(new View.OnClickListener() {
        @Override
        public void onClick(View v) {
          removeHypothesis2Button.setVisibility(View.GONE);
          hypothesis2EditText.setVisibility(View.GONE);
          recordUserEvent("removeHypothesis", "hypothesis2:::" + hypothesis2EditText.getText().toString());

        }
      });
    }

    hypothesis3EditText = ((EditText) rootView.findViewById(R.id.hypothesis3));
    if (hypothesis3EditText != null) {
      ...
      hypothesis3EditText.addTextChangedListener(new TextWatcher() {
        ...
        public void onTextChanged(CharSequence arg0, int arg1, int arg2, int arg3) {
          ...
          String currentText = hypothesis3EditText.getText().toString();
          mItem.setOrthography(currentText);
          showOrthographyOnly(rootView);
          ContentValues values = new ContentValues();
          values.put(DatumTable.COLUMN_ORTHOGRAPHY, currentText);
    ...
    final ImageButton removeHypothesis3Button = (ImageButton) rootView.findViewById(R.id.removeHypothesis3);
    if (removeHypothesis3Button != null) {
      removeHypothesis3Button.setOnClickListener(new View.OnClickListener() {
        @Override
        public void onClick(View v) {
          removeHypothesis3Button.setVisibility(View.GONE);
          hypothesis3EditText.setVisibility(View.GONE);
          recordUserEvent("removeHypothesis", "hypothesis3:::" + hypothesis3EditText.getText().toString());

        }
      });
    }

    hypothesis4EditText = ((EditText) rootView.findViewById(R.id.hypothesis4));
    if (hypothesis4EditText != null) {
      ...
      hypothesis4EditText.addTextChangedListener(new TextWatcher() {
        ...
        public void onTextChanged(CharSequence arg0, int arg1, int arg2, int arg3) {
          ...
          String currentText = hypothesis4EditText.getText().toString();
          mItem.setOrthography(currentText);
          showOrthographyOnly(rootView);
          ContentValues values = new ContentValues();
          values.put(DatumTable.COLUMN_ORTHOGRAPHY, currentText);
    ...
    final ImageButton removeHypothesis4Button = (ImageButton) rootView.findViewById(R.id.removeHypothesis4);
    if (removeHypothesis4Button != null) {
      removeHypothesis4Button.setOnClickListener(new View.OnClickListener() {
        @Override
        public void onClick(View v) {
          removeHypothesis4Button.setVisibility(View.GONE);
          hypothesis4EditText.setVisibility(View.GONE);
          recordUserEvent("removeHypothesis", "hypothesis4:::" + hypothesis4EditText.getText().toString());

        }
      });
    }

    hypothesis5EditText = ((EditText) rootView.findViewById(R.id.hypothesis5));
    if (hypothesis5EditText != null) {
      ...
      hypothesis5EditText.addTextChangedListener(new TextWatcher() {
        ...
        public void onTextChanged(CharSequence arg0, int arg1, int arg2, int arg3) {
          ...
          String currentText = hypothesis5EditText.getText().toString();
          mItem.setOrthography(currentText);
          showOrthographyOnly(rootView);
          ContentValues values = new ContentValues();
          values.put(DatumTable.COLUMN_ORTHOGRAPHY, currentText);
    ...
    final ImageButton removeHypothesis5Button = (ImageButton) rootView.findViewById(R.id.removeHypothesis5);
    if (removeHypothesis5Button != null) {
      removeHypothesis5Button.setOnClickListener(new View.OnClickListener() {
        @Override
        public void onClick(View v) {
          removeHypothesis5Button.setVisibility(View.GONE);
          hypothesis5EditText.setVisibility(View.GONE);
          recordUserEvent("removeHypothesis", "hypothesis5:::" + hypothesis5EditText.getText().toString());
  ...
  public boolean toggleAudioRecording(MenuItem item) {
    if (!this.mRecordingAudio) {
      ...
      mPromptFromCaller = getActivity().getIntent().getStringExtra(RecognizerIntent.EXTRA_PROMPT);
  ...
  protected boolean turnOffRecorder(MenuItem item) {
    ...
    Intent recognize = new Intent(getActivity(), PocketSphinxRecognitionService.class);
    getActivity().stopService(recognize);
  ...
  public void onActivityResult(int requestCode, int resultCode, Intent data) {
    getActivity();
    if (requestCode == RETURN_FROM_VOICE_RECOGNITION_REQUEST_CODE && resultCode == Activity.RESULT_OK) {
  ...
  public void processRecognitionPartialHypothesis(Intent data) {
    ...
    ArrayList<String> partialResults = data.getStringArrayListExtra(RecognizerIntent.EXTRA_RESULTS);
    ...
    recordUserEvent("recognizedPartialHypotheses", partialResults.toString());
  }
  ...
  public void processRecognitionHypotheses(Intent data) {
     ...
     */
    ArrayList<String> thesesHypotheses = data.getStringArrayListExtra(RecognizerIntent.EXTRA_RESULTS);
    if (thesesHypotheses == null || thesesHypotheses.size() == 0 || thesesHypotheses.get(0) == null
    ...
    if (hypothesis1EditText != null) {
      ...
      Log.w(Config.TAG, "hypothesis1EditText is null, cant show user results!");
    }
    if (hypothesis2EditText != null) {
      if (mHypotheses.size() > 1 && mHypotheses.get(1) != null && !"".equals(mHypotheses.get(1))) {
    ...
    if (hypothesis3EditText != null) {
      if (mHypotheses.size() > 2 && mHypotheses.get(2) != null && !"".equals(mHypotheses.get(2))) {
    ...
    if (hypothesis4EditText != null) {
      if (mHypotheses.size() > 3 && mHypotheses.get(3) != null && !"".equals(mHypotheses.get(3))) {
    ...
    if (hypothesis5EditText != null) {
      if (mHypotheses.size() > 4 && mHypotheses.get(4) != null && !"".equals(mHypotheses.get(4))) {
    ...
    if (mHypotheses.size() == 1 && mHypotheses.get(0) != null && !"".equals(mHypotheses.get(0))) {
...
//      Config.DEFAULT_UPLOAD_AUDIO_VIDEO_URL = PrivateConstants.DEFAULT_UPLOAD_AUDIO_VIDEO_URL;
  ...
  public class RecognitionReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      String thisResultsAudioFile = intent.getStringExtra(PocketSphinxRecognitionService.EXTRA_RESULT_AUDIO_FILE);
      if (thisResultsAudioFile != null) {
        addAudioFile(thisResultsAudioFile);
      }

      if (intent.getBooleanExtra(Config.EXTRA_RECOGNITION_COMPLETED, false)) {
  ...
  public void setIntentResult() {
    if (mHypotheses == null || mHypotheses.size() == 0 || mHypotheses.get(0) == null || "".equals(mHypotheses.get(0))) {
      return;
    }

    String firstGuessOrEditedGuess = mHypotheses.get(0);
    if (mPreviousActivityResult != null && mPreviousActivityResult.equals(firstGuessOrEditedGuess)) {
      return;
    }
    if (mPreviousActivityResult != null && "".equals(firstGuessOrEditedGuess)) {
  ...
  public void addAudioFile(String filename) {
    ...
    if (mAudioFiles == null) {
      ...
      if (mAudioFiles.contains(recognizerAudioFileName)) {
        Log.d(Config.TAG,
            "Already added audio file " + recognizerAudioFileName + " to the datum " + mItem.getBaseFilename());
        return;
      }
    }
    mAudioFiles = mAudioFiles + ", " + recognizerAudioFileName;
    Log.d(Config.TAG, "TODO copy file to datum file name " + datumAudioFileName + " instead original name:"
        + recognizerAudioFileName);

    mItem.addAudioFile(recognizerAudioFileName.replace(Config.DEFAULT_OUTPUT_DIRECTORY + "/", ""));
    Log.d(Config.TAG, "Datum now has audio files : " + mItem.getMediaFilesAsCSV(mItem.getAudioVideoFiles()));
    ContentValues values = new ContentValues();
    values.put(DatumTable.COLUMN_AUDIO_VIDEO_FILES, mItem.getMediaFilesAsCSV(mItem.getAudioVideoFiles()));
    getActivity().getContentResolver().update(mUri, values, null, null);
